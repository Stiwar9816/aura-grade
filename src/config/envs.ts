...
const envsSchema = joi
  .object({
    ...
    RESEND_TASK_REMINDER_TEMPLATE_ID: joi.string().required(),
    RESEND_USER_INVITATION_TEMPLATE_ID: joi.string().required(),
...
export const envs = {
  ...
  resend_task_reminder_template_id: envVars.RESEND_TASK_REMINDER_TEMPLATE_ID,
  resend_user_invitation_template_id: envVars.RESEND_USER_INVITATION_TEMPLATE_ID,
